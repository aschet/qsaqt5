...
static void(*qt_default_message_handler)(QtMsgType, const QMessageLogContext &, const QString &);
...
IdeWindow::IdeWindow(QWidget* parent, Qt::WindowFlags fl)
...
void IdeWindow::init()
{
	...
	qt_default_message_handler = qInstallMessageHandler(debugMessageOutput);
...
void IdeWindow::enableEditActions(bool enable)
{
    ...
    tabWidget->cornerWidget(Qt::TopRightCorner)->setVisible(enable);
}
